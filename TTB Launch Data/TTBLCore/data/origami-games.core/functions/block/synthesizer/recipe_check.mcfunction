...
#torch arrows
execute if score $Elemental_Arrows lcore_enabled matches 1.. if data storage origami-games.core:temp block.synthesizer{input:[{id:'minecraft:stick',Slot:4b},{id:'minecraft:torch',Slot:1b},{id:'minecraft:feather',Slot:7b}]} unless data storage origami-games.core:temp block.synthesizer.input[{Slot:0b}].Count unless data storage origami-games.core:temp block.synthesizer.input[{Slot:2b}].Count unless data storage origami-games.core:temp block.synthesizer.input[{Slot:3b}].Count unless data storage origami-games.core:temp block.synthesizer.input[{Slot:5b}].Count unless data storage origami-games.core:temp block.synthesizer.input[{Slot:6b}].Count unless data storage origami-games.core:temp block.synthesizer.input[{Slot:8b}].Count run function origami-games.core:crafting/torch_arrow
