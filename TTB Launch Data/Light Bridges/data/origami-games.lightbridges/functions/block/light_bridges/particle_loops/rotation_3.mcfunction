...
execute if block ~ ~ ~-1 barrier if score @s lb_counter < @s lb_length positioned ~ ~ ~-1 run function origami-games.lightbridges:block/light_bridges/particle_loops/rotation_3
