#run disenchanter
#@s - disenchanter
#called by origami-games.core:block/synthesizer/recipe_validity_check
...
#summon experience
summon experience_orb ~ ~1 ~ {Motion:[0d,.1d,0d],Value:20s,Tags:["de_entity","de_disenchanter_orb"]}
